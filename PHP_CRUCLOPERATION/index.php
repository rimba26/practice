    ...
    <tbody>
        <?php foreach ($data_daftar as $key):?>
            <tr>
                ...
                <td><?php echo $key['Creator'];?></td>
                <td><a href="delete.php?id_anime=<?php echo $key['id_anime']; ?>">Hapus</a> | <a href="edit.php?id_anime=<?php echo $key['id_anime']; ?>">Edit</a></td>
            </tr>
<?php endforeach; ?>
    </tbody>
</table>
    ...
    <div class="row">
        ...
        <form action="input.php" method="POST">
                <div class="form-group">
                    <label for="exampleInputEmail1">Judul Anime</label>
